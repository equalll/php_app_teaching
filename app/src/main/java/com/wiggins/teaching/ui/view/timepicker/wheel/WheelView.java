...
import com.wiggins.teaching.ui.view.timepicker.adapter.WheelAdapter;
import com.wiggins.teaching.ui.view.timepicker.model.IPickerViewData;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        while (counter < itemsVisible) {
            ...
            if (angle >= 90F || angle <= -90F) {
                ...
                float fl = (float) Math.sin(radian);
