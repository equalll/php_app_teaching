...
import com.wiggins.teaching.ui.view.timepicker.adapter.NumericWheelAdapter;
import com.wiggins.teaching.ui.view.timepicker.wheel.OnItemSelectedListener;
import com.wiggins.teaching.ui.view.timepicker.wheel.WheelView;
...
// 判断大小月及是否闰年,用来确定"日"的数据
       ...
       /* wv_seconds.setLabel(context.getString(R.string.pickerview_seconds));// 添加文字*/
        ...
        OnItemSelectedListener wheelListener_year = new OnItemSelectedListener() {
            ...
            public void onItemSelected(int index) {
                ...
                if(onTimeChangeListener != null){
                    ...
                    onTimeChangeListener.onTimeChange(currentYear + "-" + monthString + "-" + dayString);
                }
            }
        };
        // 添加"月"监听
        OnItemSelectedListener wheelListener_month = new OnItemSelectedListener() {
            ...
            public void onItemSelected(int index) {
                ...
                if(onTimeChangeListener != null){
                    int day = wv_day.getCurrentItem() + 1;
                    String monthString = month_num < 10 ? "0" + month_num : "" + month_num;
                    String dayString = day < 10 ? "0" + day : "" + day;
                    onTimeChangeListener.onTimeChange(currentYear + "-" + monthString + "-" + dayString);
                }
            }
    ...
    public void setLabels(String label_year, String label_month, String label_day, String label_hours, String label_mins, String label_seconds) {
        if (label_year!=null){
            ...
            wv_year.setLabel(view.getContext().getString(R.string.hint_year));
        }
        if (label_month!=null){
            wv_month.setLabel(label_month);
        } else {
            wv_month.setLabel(view.getContext().getString(R.string.hint_month));
        }
        if (label_day!=null){
            wv_day.setLabel(label_day);
        }else {
            wv_day.setLabel(view.getContext().getString(R.string.hint_day));
        }
        if (label_hours!=null){
            wv_hours.setLabel(label_hours);
        } else {
            wv_hours.setLabel(view.getContext().getString(R.string.hint_hour));
        }
        if (label_mins!=null){
            wv_mins.setLabel(label_mins);
        }else {
            wv_mins.setLabel(view.getContext().getString(R.string.hint_minute));
        }
        if (label_seconds!=null){
            wv_seconds.setLabel(label_seconds);
        }else {
            wv_seconds.setLabel(view.getContext().getString(R.string.hint_second));
        }
