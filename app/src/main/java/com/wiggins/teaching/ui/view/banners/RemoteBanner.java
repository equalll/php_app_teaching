package com.wiggins.teaching.ui.view.banners;
...
public class RemoteBanner extends Banner implements Parcelable {
    ...
    public RemoteBanner(String url,String title,String nums) {
        this.url = url;
        this.title = title;
        this.nums = nums;
    }
    ...
    public static final Creator<RemoteBanner> CREATOR = new Creator<RemoteBanner>() {
        @Override
